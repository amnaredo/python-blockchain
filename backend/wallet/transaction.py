...
class Transaction:
    ...
    def __init__(
        ...
        self.output = output or self.create_ouput(
            sender_wallet,
            recipient,
            amount
        )
    ...
    def create_ouput(self, sender_wallet, recipient, amount):
        """
    ...
    def reward_transaction(miner_wallet):
        """
        Generate a reward trasaction that award the miner.
        """
        output = {}
...
def main():
    ...
    print(f'restored_transaction.__dict__:\n {restored_transaction.__dict__}')
