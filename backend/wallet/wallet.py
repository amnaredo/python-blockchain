...
class Wallet:
    ...
    def verify(public_key, data, signature):
        """
        Verify a signature based on the oiginal public key and data.
        """
    ...
    def calculate_balance(blockchain, address):
        """
        Calculate the balance of the given address considering the trasaction
        ...
        for block in blockchain.chain:
            for transaction in block.data:
                if transaction['input']['address'] == address:
                    # Any time the address conducts a new transasction it resets
                    # its balance
